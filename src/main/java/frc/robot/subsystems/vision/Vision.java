...
public class Vision extends SubsystemBase {
    ...
    /**
     * Returns the best target, which can be used for auto aligning
     *
     * @param cameraIndex The index of the camera to use
     */
    ...
    public void periodic() {
        ...
        for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
            ...
            Logger.recordOutput(
                ...
                "/RobotPosesAccepted",
                robotPosesAccepted.toArray(
                    new Pose3d[robotPosesAccepted.size()]
                )
            );
            Logger.recordOutput(
                "Vision/Camera" +
                Integer.toString(cameraIndex) +
                "/RobotPosesRejected",
                robotPosesRejected.toArray(
                    new Pose3d[robotPosesRejected.size()]
                )
            );
